    ...
    <div class="container mx-auto px-4">
      ...
      <div class="flex flex-wrap justify-center gap-8 max-w-6xl mx-auto">
        <div
          ...
          :key="agent.title"
          class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl hover:scale-105 transition duration-300 w-80 flex flex-col justify-between"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          <div>
            <h3 class="text-xl font-bold mb-2 text-gray-800">{{ agent.title }}</h3>
